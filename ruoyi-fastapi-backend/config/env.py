...
class VolcengineTosSettings(BaseSettings):
    """
    火山引擎 TOS（MV P 预传视频）
    """

    volcengine_tos_access_key: str = ''
    volcengine_tos_secret_key: str = ''
    volcengine_tos_region: str = 'cn-beijing'
    volcengine_tos_endpoint: str = 'tos-cn-beijing.volces.com'
    volcengine_tos_bucket: str = ''
    volcengine_tos_presign_expires: int = 3600
    volcengine_tos_cdn_domain: str = ''  # CDN 域名，勿尾随斜杠，如 https://static.example.com
...
class GetConfig:
    ...
    def get_tos_config(self) -> VolcengineTosSettings:
        """
        获取火山 TOS 配置
        """
        return VolcengineTosSettings()
...
# TOS 直传
TosConfig = get_config.get_tos_config()
